/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts` (hash: 49e56fc4a9ebcd270d99ebd7767e1f2d)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		QA_TEST_FULL_NAME: string;
		QA_TEST_PHONE: string;
		QA_TEST_CITY: string;
		QA_TEST_ZIP: string;
		QA_TEST_SESSION_ID: string;
		QA_TEST_GOAL: string;
	}
}
